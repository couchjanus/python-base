...
class TodoApp(App):
    ...
    def add_project(self):
        self.projects.data.append({'title': 'New project', 'description': '', 'deadline': self.__current_date()[0]})
    ...
    def set_project_deadline(self, project_index, project_deadline):
        self.projects.data[project_index]['deadline'] = project_deadline
        self.save_projects()
        self.refresh_projects()
    ...
    def projects_fn(self):
        return join(self.user_data_dir, 'todo.json')
